    ...
    <div class = "container">
        ...
        <div class = "list-accordion">
            <?php if (isset($data) && !empty($data)) { ?>
                <h4 class = "margin-bottom-30 padding-left-0 padding-right-0"><?php echo count($data); ?> Categories Listed / <?php echo ($id != '') ? $id : 'All'; ?></h4>

                <ul class = "categories-list panel-group" id = "cat-acor-list" aria-multiselectable = "true" role = "tablist">
                    <?php
                        $list_count = 1;
                                    ...
                                    <div class = "panel-collapse collapse" id = "CollapseDefault-<?php echo $list_count; ?>" aria-labelledby = "HeadingDefault-<?php echo $list_count; ?>" role = "tabpanel">
                                        <ul class = "panel-body">
                                            <?php foreach ($parent['child'] as $child): ?>
                                                <li>
                                                    <a href = "<?php echo Yii::$app->request->baseUrl . '/cards/item/' . $child['id']; ?>">
                            ...
                            <?php }
                                ...
                                <li class = "panel col-sm-3">
                                    <div class = "panel-heading">
                                        <a class = "panel-title collapsed" href = "<?php echo Yii::$app->request->baseUrl . '/cards/item/' . $parent['id']; ?>" > <?php echo $parent['type']; ?> </a>
                                    </div>
                                </li>

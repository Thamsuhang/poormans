...
<div class="page animsition">
    ...
    <div class="page-content padding-30 container-fluid">
        <div class="row">
            <div class="col-md-6">
                <div class="panel">
                    <form action="<?php echo Yii::$app->request->baseUrl;?>/user/change-password" name="changePassword" data-tablename="change-password" data-action="operator-password" method="post" class="form-horizontal change-password">
                        ...
                        <div class="panel-footer">
                            <button type="submit" class="btn btn-sm btn-primary btn-icon margin-bottom-20 margin-top-20 pull-right"><i class="icon fa-save"></i> Change</button>

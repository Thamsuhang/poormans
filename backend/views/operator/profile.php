...
<div class="page animsition">
    <div class="page-header  padding-bottom-0">
        ...
        <div class="page-header-actions">
            <a href="<?php echo Yii::$app->request->baseUrl; ?>/operator/edit-profile" type="button" class="btn btn-sm btn-icon btn-primary btn-round" data-toggle="tooltip" data-original-title="Edit" data-placement="left">
                <i class="icon ti-pencil" aria-hidden="true"></i>
            </a>
            <a href="<?php echo Yii::$app->request->baseUrl; ?>/operator/change-profile-picture" type="button" class="btn btn-sm btn-icon btn-success btn-round" data-toggle="tooltip" data-original-title="Change Profile Picture" data-placement="left">
                <i class="icon fa-image" aria-hidden="true"></i>
            </a>
            <a href="<?php echo Yii::$app->request->baseUrl; ?>/operator/change-password" type="button" class="btn btn-sm btn-icon btn-danger btn-round" data-toggle="tooltip" data-original-title="Change Password" data-placement="left">
                                ...
                                <div class="widget widget-shadow">
                                    <div class="widget-content bg-white padding-20 user-address">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <i class="icon fa-map-marker"></i>Billing Address
                                                <?php echo !empty($user['billing_address']) ? $user['billing_address'] : ''; ?>
                                            </li>
                                            <li>
                                                <i class="icon fa-map-marker"></i>Shipping Address
                                                <?php echo !empty($user['shipping_address']) ? $user['shipping_address'] : ''; ?>
                                            </li>
                                        </ul> 
                                    </div>
                                </div>

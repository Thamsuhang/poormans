                        ...
                        <div class = "nav-tabs-horizontal page-tabs">
                            <ul class = "nav nav-tabs" data-plugin = "nav-tabs" role = "tablist">
                                <li class = "active" role = "presentation">
                                    <a data-toggle = "tab" href = "#sliders" aria-controls = "sliders" role = "tab">Homepage Settings</a>
                                </li>

                                <li class = "dropdown" role = "presentation">
                                    <a class = "dropdown-toggle" data-toggle = "dropdown" href = "#" aria-expanded = "false">
                                        <span class = "caret" style = "margin-right:8px;"></span>Menu
                                    </a>
                                ...
                                <div class = "tab-pane active" id = "sliders" role = "tabpanel">
                                    <div class = "settings-form">
                                        <form enctype = "multipart/form-data" autocomplete = "off" method = "post" action = "<?php echo Yii::$app->request->baseUrl; ?>/websettings/slider">
                                            <input type = "hidden" name = "<?php echo Yii::$app->request->csrfParam; ?>" value = "<?php echo Yii::$app->request->csrfToken; ?>"/> <input type = "hidden" name = "page-details[page-id]" value = "<?php echo $page_id; ?>">
                                            ...
                                            <div class = "form-group">
                                                <label class = "control-label">Upload New Image Image</label> <input type = "file" class = "form-control" name = "image"/>
                                        ...
                                        <form autocomplete = "off" method = "post" action = "<?php echo Yii::$app->request->baseUrl; ?>/websettings/slider">
                                            ...
                                            <div class = "content-slider-container">
                                                <div class = "form-group margin-bottom-0">
                                                    ...
                                                    <a class = "  btn add-content-slider-item" href = "javascript:void(0);"><i class = "icon fa-plus icon-right"></i>Add More</a>
                                                        ...
                                                        if (isset($datacenter['slider']) && Misc::exists($datacenter['slider'])) {
                                                            ...
                                                            foreach ($datacenter['slider'] as $slider) : ?>
                                                                <div class = "row content-slider-item">
                                                                    <input type = "hidden" value = "<?php echo $slider['id']; ?>" name = "contentSlider[<?php echo $counter; ?>][id]"> <input type = "hidden" value = "<?php echo $page_id; ?>" name = "contentSlider[<?php echo $counter; ?>][page-id]">
                                                                    ...
                                                                    <div class = "form-group col-sm-2">
                                                                        ...
                                                                        <a href = "javascript:void(0);" data-id = "<?php echo $slider['id']; ?>" class = "btn btn-sm form-control delete-content-slider-item"><i class = "icon fa-trash icon-left"></i> Delete</a>
                                                                    </div>
                                                                </div>
                                                                <?php
                                                                $counter++;
                                                            ...
                                                            <div class = "row content-slider-item">
                                                                <input type = "hidden" value = "" name = "contentSlider[0][id]"> <input type = "hidden" value = "1" name = "contentSlider[0][page-id]">

                                                                <div class = "form-group col-sm-5">
                                                                    <label class = "control-label">Title</label> <input type = "text" value = "" class = "form-control" name = "contentSlider[0][title]" placeholder = "Title" autocomplete = "off">
                                                                </div>
                                                                <div class = "form-group col-sm-5">
                                                                    <label class = "control-label">Subtitle</label> <input type = "text" value = "" class = "form-control" name = "contentSlider[0][subtitle]" placeholder = "Subtitle" autocomplete = "off">
                                                                </div>
                                                                <div class = "form-group col-sm-2">
                                                                    <label class = "control-label">&nbsp;</label>

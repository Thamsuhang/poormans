...
!function (document, window, $) {
    ...
    $(document).ready(function ($) {
        ...
        $("#exampleAccountForm").formValidation({
            ...
            framework: "bootstrap",
            fields: {
                number: {validators: {notEmpty: {message: "The credit card number is required"}}},
                cvv: {validators: {notEmpty: {message: "The CVV number is required"}}}
            }
        });
        var defaults = $.components.getDefaults("wizard"), options = $.extend(!0, {}, defaults, {buttonsAppendTo: ".panel-body"}), wizard = $("#exampleWizardForm").wizard(options).data("wizard");
        ...
        var defaults = $.components.getDefaults("wizard"), options = $.extend(!0, {}, defaults, {
            onInit: function () {
                $("#exampleFormContainer").formValidation({
                    ...
                    fields: {
                        ...
                        number: {validators: {notEmpty: {message: "The credit card number is not valid"}}},
                        cvv: {validators: {notEmpty: {message: "The CVV number is required"}}}
                    }
                })
            }, validator: function () {
                var fv = $("#exampleFormContainer").data("formValidation"), $this = $(this);
        ...
        var defaults = $.components.getDefaults("wizard"), options = $.extend(!0, {}, defaults, {
            ...
            templates: {
                buttons: function () {
                    var options = this.options, html = '<div class="btn-group btn-group-sm"><a class="btn btn-default btn-outline" href="#' + this.id + '" data-wizard="back" role="button">' + options.buttonLabels.back + '</a><a class="btn btn-success btn-outline pull-right" href="#' + this.id + '" data-wizard="finish" role="button">' + options.buttonLabels.finish + '</a><a class="btn btn-default btn-outline pull-right" href="#' + this.id + '" data-wizard="next" role="button">' + options.buttonLabels.next + "</a></div>";
                    return html
                }
            },
            buttonLabels: {
        ...
        var defaults = $.components.getDefaults("wizard"), options = $.extend(!0, {}, defaults, {
            ...
            onAfterChange: function (prev, step) {
                var total = this.length(), current = step.index + 1, percent = current / total * 100;

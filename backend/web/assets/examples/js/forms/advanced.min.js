...
! function(document, window, $) {
    ...
    $(document).ready(function($) {
        ...
        function() {
            $("#inlineDatepicker").datepicker(), $("#inlineDatepicker").on("changeDate", function(event) {
        ...
        function() {
            $("#inputTokenfieldEvents").on("tokenfield:createtoken", function(e) {
                ...
                } else alert("Token removed! Token value was: " + e.attrs.value)
            }).tokenfield()
        }(),
        function() {
            ...
            cities.initialize();
            var options = $.extend(!0, {}, $.components.getDefaults("tagsinput"), {
                    itemValue: "value",
                    itemText: "text",
                    typeaheadjs: [{
                        hint: !0,
        ...
        function() {
            $(".multi-select-methods").multiSelect(), $("#buttonSelectAll").click(function() {

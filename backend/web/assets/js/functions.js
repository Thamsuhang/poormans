            ...
            if(data != false) {
                if($(form).data('tablename') == 'blog'){ 
                    if($(form).data('action') == 'add' || $(form).data('action') == 'edit') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/blogs'); return false;
                    } else {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', ''); return false;
                    }
                }
                else if($(form).data('tablename') == 'portfolio'){ 
                    if($(form).data('action') == 'add' || $(form).data('action') == 'edit') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/portfolio'); return false;
                    } else {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', ''); return false;
                    }
                }
                    ...
                    if($(form).data('action') == 'add' || $(form).data('action') == 'edit') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/review'); return false;
                    } else {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', ''); return false;
                    }
                }
                    ...
                    if($(form).data('action') == 'add') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/portfolio/type'); return false;
                    } 
                }
                else if($(form).data('tablename') == 'news'){ 
                    if($(form).data('action') == 'add' || $(form).data('action') == 'edit') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/news'); return false;
                    } else {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', ''); return false;
                    }
                }
                    ...
                    if($(form).data('action') == 'add') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/testimonials/'); return false;
                    } else {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/testimonials/'); return false;
                    }
                }
                else if($(form).data('tablename') == 'settings'){
                    typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/settings'); return false;
                }
                else if($(form).data('tablename') == 'slider'){
                    if($(form).data('action') == 'add' || $(form).data('action') == 'edit') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/slider'); return false;
                    } else {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', ''); return false;
                    }
                }
                ...
                if($(form).data('tablename') == 'home-slider'){ 
                    if($(form).data('action') == 'edit') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/home-slider'); return false;
                    } else {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', ''); return false;
                    }
                }
                    ...
                    if($(form).data('action') == 'create-admin') {
                        typeAlertRedirect('Success', 'You have successfully created new administrator.', 'success', baseUrl+'/user/administrators'); return false;
                    }
                    else if($(form).data('action') == 'update-admin') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/user/administrators'); return false;
                    }
                    else if($(form).data('action') == 'create-operator') {
                        typeAlertRedirect('Success', 'You have successfully created new operator.', 'success', baseUrl+'/user/operators'); return false;
                    }
                    else if($(form).data('action') == 'update-operator') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/user/operators'); return false;
                    }
                }
                else if($(form).data('tablename') == 'administrator'){ 
                    if($(form).data('action') == 'edit') {
                        typeAlertRedirect('Success', 'You have successfully updated your profile.', 'success', baseUrl+'/admin/profile'); return false;
                    }
                }
                else if($(form).data('tablename') == 'operator'){ 
                    if($(form).data('action') == 'edit') {
                        typeAlertRedirect('Success', 'You have successfully updated your profile.', 'success', baseUrl+'/operator/profile'); return false;
                    }
                }
                else if($(form).data('tablename') == 'change-password'){ 
                    if(data.status == 'ss') {
                        var role = $(form).data('action') == 'admin-password' ? 'admin' : 'operator'; 
                        typeAlertRedirect('Success', 'You have successfully updated your password.', 'success', baseUrl+'/'+role+'/profile'); return false;
                    }
                    else if(data.status == 'mm') {
                        typeAlert('Error', 'Password Mismatch. Please try again.', 'warning'); return false;
                    }
                    else if(data.status == 'ff') {
                        typeAlert('Error', 'Failed to updated your password. Please try again.', 'warning'); return false;
                    }
                    else if(data.status == 'icp') {
                        typeAlert('Error', 'Old Password did not match. Please try again.', 'warning'); return false;
                    }
                }
                else if($(form).data('tablename') == 'seo'){
                    if($(form).data('action') == 'edit') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/seo'); return false;
                    } else {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', ''); return false;
                    }
                }
                    ...
                    if($(form).data('action') == 'edit') {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/faq'); return false;
                    } else {
                        typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', ''); return false;
                    }
                }
                else if($(form).data('tablename') == 'page'){
                    typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/page'); return false;
                }
                else if($(form).data('tablename') == 'section-config'){
                    typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/section/content-edit/'+data.slug); return false;
                }
                else if($(form).data('tablename') == 'section-content'){
                    typeAlertRedirect('Success', 'Data has been saved Successfully.', 'success', baseUrl+'/section'); return false;
                }
                else{
                ...
                if($(form).data('tablename') == ''){
                    typeAlert('Error!', 'Sorry, Could not update the data at this time. Please try again.', 'warning'); return false;
                }
                else{
                    typeAlert('Error!', 'Sorry, Could not save the data at this time. Please try again.', 'warning'); return false;
                }
            }
        }
    });

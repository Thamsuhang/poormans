        ...
        run: function (next) {
            this.polyfillIEWidth(), "undefined" != typeof $.site.menu && $.site.menu.init(), "undefined" != typeof $.site.menubar && ($(".site-menubar").on("changing.site.menubar", function () {
                ...
                if ($target.hasClass("navbar-search-overlap"))
                    $target.find("input").focus(), e.preventDefault();
                ...
                navbars: [{
                        ...
                        content: ['<div class="site-menubar-footer">' +
                                    '<a href="' + baseUrl + '" data-placement="top" data-toggle="tooltip" data-original-title="Dashboard">' +
                                    '<span class="icon wb-desktop" aria-hidden="true"></span>' +
                                    '</a>' +
                                    '<a href="javscript:void(0);" class="fold-show disabled" data-placement="top" data-toggle="tooltip" data-original-title="Profile">' +
                                    '<span class="icon" aria-hidden="true"></span>' +
                                    '</a>' +
                                    '<a href="' + baseUrl + '/site/logout" data-placement="top" data-toggle="tooltip" data-original-title="Logout">' +

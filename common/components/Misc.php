<?php
    ...
    class Misc extends Component {
        ...
        public static function getStates() {
            $data = Query::queryAll("SELECT * FROM `states` ORDER BY  `name` ASC ");
        ...
        public static function directory_arrayToJson($array) {
            $items = [];
        ...
        public static function generateMarginPaddingCss() {
            $l = 1;
            $x = 320;
            for ($m = 0; $m <= $x; $m += $l) {
                echo '.m-' . $m . ' {  margin: ' . $m . 'px; }';
            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.m-t-' . $m . ' {  margin-top: ' . $m . 'px; }';

            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.m-b-' . $m . ' {  margin-bottom: ' . $m . 'px; }';

            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.m-l-' . $m . ' {  margin-left: ' . $m . 'px; }';

            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.m-r-' . $m . ' {  margin-right: ' . $m . 'px; }';

            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.m-h-' . $m . ' {   margin-left: ' . $m . 'px; margin-right: ' . $m . 'px; }';

            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.m-v-' . $m . ' {   margin-top: ' . $m . 'px; margin-bottom: ' . $m . 'px; }';

            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.p-' . $m . ' {  padding: ' . $m . 'px; }';

            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.p-t-' . $m . ' {  padding-top: ' . $m . 'px; }';

            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.p-b-' . $m . ' {  padding-bottom: ' . $m . 'px; }';

            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.p-l-' . $m . ' {  padding-left: ' . $m . 'px; }';
            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.p-l-' . $m . ' {  padding-right: ' . $m . 'px; }';
            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.p-h-' . $m . ' {   padding-left: ' . $m . 'px; padding-right: ' . $m . 'px; }';

            }
            for ($m = 0; $m <= 320; $m++) {
                echo '.p-v-' . $m . ' {   padding-top: ' . $m . 'px; padding-bottom: ' . $m . 'px; }';
